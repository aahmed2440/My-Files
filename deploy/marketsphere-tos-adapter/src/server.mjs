...
const SOURCE_CONTRACT = {
  ...
  state_machine: [
    ...
    'REALTIME_STATUS_UNVERIFIED', 'DELAYED_DATA', 'ENTITLEMENT_PENDING', 'CONTINUITY_PENDING',
    'DEGRADED', 'STALE', 'DISCONNECTED', 'ELIGIBLE_FOR_GOVERNED_SOURCE_CERTIFICATION_REVIEW'
  ],
